...
class MultilabelStratifiedSplitter:
    ...
    def get_dataset_splits(self, encoded_labels_df):
        ...
        train_ids, train_labels, val_test_ids, val_test_labels = iterative_train_test_split(track_ids, labels,
                                                                                            test_size=test_val_split_ratio)

        test_split_ration = self.get_test_split_ratio()
        val_ids, val_labels, test_ids, test_labels = iterative_train_test_split(val_test_ids, val_test_labels,
